...
export default function DennisBinder(){
  ...
  function submitSignature(){
    ...
    fetch("/api/signatures",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:"dennis",data:{signed:true,name:signatureName,date:signatureDate}})}).catch(()=>{});}catch(e){}
    setSigned(true);
  }
